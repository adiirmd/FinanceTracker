...
async function checkSpendingAlert(justAdded) {
  ...
  const message = threshold >= SHOUT_FROM ? `⚠️ <b>PENGELUARAN HARI INI SUDAH MENCAPAI ${formatRupiah(threshold).toUpperCase()}!</b>` : `Pengeluaran hari ini sudah mencapai ${formatRupiah(threshold)}`;
